...
This script is used to simulate the 3-compartment model. .
This is the reference test case: thus we assume baseline parameter values.
...
mod_fluid_transfer_tumor_pv_e = 1.
...
mod_diff_transfer_tumor_pv_e = 1.
