...
# modulated
mod_phi_cytotoxic_e = 1.
mod_phi_cytotoxic_pa = 1.
mod_phi_cytotoxic_pv = 1.

mod_phi_vasogenic_e = 1.5
...
mod_fluid_transfer_cytotoxic_pv_e = 1.

mod_fluid_transfer_vasogenic_pa_e = 2.
mod_fluid_transfer_vasogenic_pv_e = 2.

mod_fluid_transfer_tumor_pa_e = 2.
mod_fluid_transfer_tumor_pv_e = 2.

mod_diff_transfer_cytotoxic_pa_e = 1.
mod_diff_transfer_cytotoxic_pv_e = 1.

mod_diff_transfer_vasogenic_pa_e = 2.
mod_diff_transfer_vasogenic_pv_e = 2.

mod_diff_transfer_tumor_pa_e = 2.
mod_diff_transfer_tumor_pv_e = 2.
